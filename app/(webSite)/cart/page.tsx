...
export default function Cart() {
  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      {articles.length === 0 ? (
        <div className="flex justify-center items-center h-[50vh] text-4xl text-muted-foreground gap-4">
          <FaCartArrowDown />
          <p className="text-center ">Your cart is empty </p>
        </div>
      ) : 

      (<div className="flex min-h-[50vh] relative">
          ...
          {articles.map((article) => (
            ...
            >
              ...
              <div className="flex w-[20%] items-center relative">
                <span className="ml-4 text-primary">{article.price} dh</span>
              </div>
              <div
                onClick={() => handleRemoveArticle(article.id)}
                className="flex ease-in-out duration-300 hover:text-red-600 hover:cursor-pointer items-center"
              >
