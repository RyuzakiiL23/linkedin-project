    ...
    <div className="my-10 lg:w-[1400px] mx-auto">
      ...
      <div className="flex gap-20 justify-between">
        {products.map((product) => (
          <div key={product.name} className="w-[400px] h-[270px] p-8 bg-border relative overflow-hidden group cursor-default">
            <h4 className="font-bold text-xl pb-2 text-muted-foreground">{product.name}</h4>
